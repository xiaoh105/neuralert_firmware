...
extern void	get_scan_result_sample(void *param);
...
static const app_task_info_t	sample_apps_table[] = {
    ...
    // ETC Samples
#if defined ( __GET_SCAN_RESULT_SAMPLE__)
    { SAMPLE_SCAN_RESULT,			get_scan_result_sample,				1024, (OS_TASK_PRIORITY_USER + 6), FALSE, FALSE,	UNDEF_PORT,				RUN_ALL_MODE },
#endif // (__GET_SCAN_RESULT_SAMPLE__)
