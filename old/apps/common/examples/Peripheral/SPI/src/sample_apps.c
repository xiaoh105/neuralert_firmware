...
extern void	run_spi_sample(void *param);
#endif // (__PERIPHERAL_SAMPLE_SPI__)
...
static const app_task_info_t	sample_apps_table[] = {
    ...
    // Peripheral Samples
#if defined (__PERIPHERAL_SAMPLE_SPI__)
    { SAMPLE_SPI,			run_spi_sample,					512, (OS_TASK_PRIORITY_USER + 6), FALSE, FALSE,	UNDEF_PORT,				RUN_ALL_MODE },
#endif // (__PERIPHERAL_SAMPLE_SPI__)
