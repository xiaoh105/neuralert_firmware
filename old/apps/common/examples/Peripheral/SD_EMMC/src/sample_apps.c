...
extern void	run_sd_emmc_sample(void *param);
#endif
...
static const app_task_info_t	sample_apps_table[] = {
    ...
    // Peripheral Samples
#if defined (__PERIPHERAL_SAMPLE_SD_EMMC__)
    { SAMPLE_SD_EMMC,			run_sd_emmc_sample,					512, (OS_TASK_PRIORITY_USER + 6), FALSE, FALSE,	UNDEF_PORT,				RUN_ALL_MODE },
#endif // (__PERIPHERAL_SAMPLE_SD_EMMC__)
