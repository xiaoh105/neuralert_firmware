...
extern void	rtc_timer_sample(void *param);
...
static const app_task_info_t	sample_apps_table[] = {
    ...
    { SAMPLE_RTC_TIMER,			rtc_timer_sample,					512, (OS_TASK_PRIORITY_USER + 6), FALSE, TRUE,	UNDEF_PORT,				RUN_ALL_MODE },
#else
    { SAMPLE_RTC_TIMER,			rtc_timer_sample,					512, (OS_TASK_PRIORITY_USER + 6), TRUE, TRUE,	UNDEF_PORT,				RUN_ALL_MODE },
