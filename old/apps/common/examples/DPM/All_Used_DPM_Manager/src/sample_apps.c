...
extern void all_used_dpm_manager_sample(void *param);
...
static const app_task_info_t	sample_apps_table[] = {
    ...
    // DPM Manager Samples
#if defined (__ALL_USED_DPM_MANAGER_SAMPLE__)
    { SAMPLE_ALL_USED_DPM_MNG,		all_used_dpm_manager_sample,		256, (OS_TASK_PRIORITY_USER + 6), TRUE,	FALSE,  UNDEF_PORT,				RUN_ALL_MODE },
#endif // (__ALL_USED_DPM_MANAGER_SAMPLE__)
