...
// Network Communication Samples
#if defined (__TCP_CLIENT_KA_DPM_SAMPLE__)
extern void	tcp_client_ka_dpm_sample(void *param);
#endif // (__TCP_CLIENT_KA_DPM_SAMPLE__)
...
static const app_task_info_t	sample_apps_table[] = {
    ...
    // Network Samples
#if defined (__TCP_CLIENT_KA_DPM_SAMPLE__)
    { SAMPLE_TCP_CLI_KA_DPM,				tcp_client_ka_dpm_sample,					1024 / sizeof(StackType_t), (OS_TASK_PRIORITY_USER + 6), TRUE, FALSE,	TCP_CLI_KA_TEST_PORT,		RUN_ALL_MODE },
#endif // (__TCP_CLIENT_KA_DPM_SAMPLE__)
