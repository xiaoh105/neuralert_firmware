...
extern void http_server_sample_entry(void *param);
...
#if defined (__HTTP_SERVER_SAMPLE__)
    { SAMPLE_HTTP_SERVER,			http_server_sample_entry,			1024, (OS_TASK_PRIORITY_USER + 6), TRUE, FALSE,	UNDEF_PORT,				RUN_ALL_MODE },
#endif // (__HTTP_SERVER_SAMPLE__)
