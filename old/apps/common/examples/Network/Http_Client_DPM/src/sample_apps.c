...
extern void http_client_dpm_sample_entry(void *param);
...
static const app_task_info_t	sample_apps_table[] = {
    ...
    // Network Samples
#if defined (__HTTP_CLIENT_DPM_SAMPLE__)
    { SAMPLE_HTTP_CLIENT_DPM,			http_client_dpm_sample_entry,		   2560, (OS_TASK_PRIORITY_USER + 6), TRUE, FALSE,	UNDEF_PORT,				RUN_ALL_MODE },
#endif // (__HTTP_CLIENT_DPM_SAMPLE__)
