...
extern void websocket_client_sample(void *param);
...
static const app_task_info_t	sample_apps_table[] = {
    ...
    // Network Samples
#if defined (__WEBSOCKET_CLIENT_SAMPLE__)
    { SAMPLE_WEBSOCKET_CLIENT,			websocket_client_sample,	1024, (OS_TASK_PRIORITY_USER + 6), TRUE, FALSE,	UNDEF_PORT,	RUN_ALL_MODE },
