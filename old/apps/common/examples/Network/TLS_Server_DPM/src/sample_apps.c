...
extern void	tls_server_dpm_sample(void *param);
#endif // (__TLS_SERVER_DPM_SAMPLE__)
...
static const app_task_info_t	sample_apps_table[] = {
    ...
    // Network Samples
#if defined (__TLS_SERVER_DPM_SAMPLE__)
    { SAMPLE_TLS_SVR_DPM,				tls_server_dpm_sample,					(128 * 10), (OS_TASK_PRIORITY_USER + 6), TRUE, FALSE,	TLS_SVR_TEST_PORT,		RUN_ALL_MODE },
#endif // (__TLS_SERVER_DPM_SAMPLE__)
