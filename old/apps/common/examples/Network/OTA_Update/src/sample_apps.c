...
extern void ota_update_sample_entry(void *param);
...
static const app_task_info_t	sample_apps_table[] = {
    ...
    // Network Samples
#if defined (__OTA_UPDATE_SAMPLE__)
    { SAMPLE_OTA_UPDATE,			ota_update_sample_entry,			1024, (OS_TASK_PRIORITY_USER + 6), TRUE, FALSE,	UNDEF_PORT,				RUN_ALL_MODE },
#endif // (__OTA_UPDATE_SAMPLE__)
