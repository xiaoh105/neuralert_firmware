...
#if defined (__UDP_CLIENT_DPM_SAMPLE__)
extern void	udp_client_dpm_sample(void *param);
#endif // (__UDP_CLIENT_DPM_SAMPLE__)
...
static const app_task_info_t	sample_apps_table[] = {
    ...
    // Network Samples
#if defined (__UDP_CLIENT_DPM_SAMPLE__)
    { SAMPLE_UDP_CLI_DPM,				udp_client_dpm_sample,					1024 / sizeof(StackType_t), (OS_TASK_PRIORITY_USER + 6), TRUE, FALSE,	UDP_CLI_TEST_PORT,		RUN_ALL_MODE },
#endif // (__UDP_CLIENT_DPM_SAMPLE__)
