...
enum wpa_handshwke_states {
	WPA_HANDSHAKE_1_OF_4_RECEIVED,

	WPA_HANDSHAKE_2_OF_4_SENT,

	WPA_HANDSHAKE_3_OF_4_RECEIVED,

	WPA_HANDSHAKE_4_OF_4_SENT
};
#endif /* ENABLE_WPA_STATE_DBG */
...
enum fc9000_wifi_mode {
	DA16X_WIFI_MODE_BGN,	/* 0 */
	DA16X_WIFI_MODE_GN,	/* 1 */
	DA16X_WIFI_MODE_BG,	/* 2 */
	DA16X_WIFI_MODE_N_ONLY,	/* 3 */
	DA16X_WIFI_MODE_G_ONLY,	/* 4 */
	DA16X_WIFI_MODE_B_ONLY,	/* 5 */
	DA16X_WIFI_MODE_MAX
};
