...
static inline int hostapd_drv_set_ap_power(	struct hostapd_data *hapd,
							int type, int power, int *get_power)
{
...
static inline int hostapd_drv_chk_keep_alive(struct hostapd_data *hapd,
					     const u8 *addr)
{
...
static inline int hostapd_drv_set_ap_isolate(	struct hostapd_data *hapd,
							int isolate)
{
...
static inline int hostapd_drv_ap_pwrsave(struct hostapd_data *hapd,
					     int ps_state, int timeout)
{
