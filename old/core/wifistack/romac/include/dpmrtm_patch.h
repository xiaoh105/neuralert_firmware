...
static inline void dpm_set_env_uc_period_ty(struct dpm_param *dpmp,
											unsigned char period_ty)
{
	dpmp->env.uc.period_ty = period_ty;
}
...
{
	dpmp->env.bor.reset_en = reset_en;
}
...
static inline void dpm_set_env_tcpka(struct dpm_param *dpmp, unsigned char en,
		...
		unsigned long period)
{
	dpmp->env.tcpka.en = en;
	dpmp->env.tcpka.fix = fix;
	dpmp->env.tcpka.period_ty = period_ty;
	dpmp->env.tcpka.prep = prep;
	dpmp->env.tcpka.ta = ta;
...
static inline void dpm_set_env_tcpka_payload_len(struct dpm_param *dpmp,
		unsigned int payload_len)
{
	dpmp->env.tcpka.payload_len = payload_len;
}
...
{
	dpmp->env.tcpka.chkport_period_ty = chkport_period_ty;
}
...
{
	dpmp->env.tcpka.chkport_period = chkport_period;
}
...
{
	dpmp->env.fboot.period0_100ms = period0_100ms;
}
...
{
	dpmp->env.fboot.period0_drift = period0_drift;
}
...
{
	dpmp->env.fboot.period1_100ms = period1_100ms;
}
...
{
	dpmp->env.fboot.period1_drift = period1_drift;
}
...
{
	dpmp->env.bufp.en = en;
	dpmp->env.bufp.fix = fix;
	dpmp->env.bufp.period_ty = period_ty;
	dpmp->env.bufp.prep = prep;
	dpmp->env.bufp.ta = ta;
	dpmp->env.bufp.done_en = done_en;
	dpmp->env.bufp.change_en = change_en;
	dpmp->env.bufp.auto_set = auto_set;
	dpmp->env.bufp.chk_arp = chk_arp;
...
{
	return dpmp->st.txretry_setps_en;
}
...
{
	return dpmp->st.bufp_probe_pending;
}
...
{
	return dpmp->st.bufp_arp_status;
}
...
{
	return dpmp->st.bufp_probe_status;
}
...
static inline void dpm_set_st_rx_on_us_round(struct dpm_param *dpmp,
		unsigned long rx_on_us)
{
	dpmp->st.rx_on_us_round += rx_on_us;
...
{
	return (dpmp->st.rx_on_us_round + (rx_on_us & 0x03ff)) >> 10;
}
