...
#define DX_ENV_CC_HOST_INT_REG_OFFSET   0x0A0UL 	/* TEST for Renesas */
...
#define DX_ENV_CC_RST_N_REG_OFFSET   0x0E4UL		/* TEST for Renesas : Warm 0xA8 -> 0xE4 */
...
#define DX_ENV_CC_COLD_RST_REG_OFFSET   0x0E8UL		/* TEST for Renesas : Cold 0xFC -> 0xE8 */
#define DX_ENV_CC_COLD_RST_VALUE_BIT_SHIFT  0x0UL
#define DX_ENV_CC_COLD_RST_VALUE_BIT_SIZE   0x1UL
#define DX_ENV_OTP_FILTER_OFF_REG_OFFSET   0x100UL	/* TEST for Renesas : added */
#define DX_ENV_OTP_FILTER_OFF_VALUE_BIT_SHIFT  0x0UL
#define DX_ENV_OTP_FILTER_OFF_VALUE_BIT_SIZE   0x1UL
