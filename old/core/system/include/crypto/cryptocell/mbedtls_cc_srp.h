...
typedef struct mbedtls_srp_context {
    ...
    mbedtls_srp_group_param     groupParam; // N, g, Np
    /*! The hash mode. */
    ...
    /*! The modulus. */
    mbedtls_srp_modulus     ephemPriv;  // a or b
    /*! The modulus size. */
    size_t          ephemPrivSize;
    /*! The user-name digest. */
    mbedtls_srp_digest      userNameDigest; // M
    /*! The cred digest. */
    mbedtls_srp_digest      credDigest; // p
    /*! The SRP K multiplier. */                        //
    mbedtls_srp_digest      kMult;      // k multiplier
}mbedtls_srp_context;
...
CIMPORT_C CCError_t  mbedtls_srp_init(
                ...
                size_t          modSizeInBits,  /*!< [in] The size of the SRP modulus in bits. Valid values are:<ul><li>1024</li><li>1536</li><li>2048</li><li></li><li>3072</li></ul> */
...
CIMPORT_C CCError_t  mbedtls_srp_host_proof_verify_and_calc(
                ...
                mbedtls_srp_secret      sharedSecret, /*!< [out] A pointer to the SRP shared secret (K). */
...
CIMPORT_C CCError_t  mbedtls_srp_user_proof_verify(
                mbedtls_srp_secret    sharedSecret,  /*!< [in] A pointer to the SRP shared secret (K). */
                mbedtls_srp_modulus   userPubKeyA,   /*!< [in] A pointer to the public ephmeral key of the user (A). */
                mbedtls_srp_digest    userProof,     /*!< [in] A pointer to the SRP user proof buffer (M1). */
