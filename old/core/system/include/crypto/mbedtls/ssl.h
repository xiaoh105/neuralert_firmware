...
#define MBEDTLS_SSL_PRESET_DA16X                3
#define MBEDTLS_SSL_PRESET_DA16X_ONLY_HW        4
...
struct mbedtls_ssl_config
{
    ...
    /** Callback to export key block and master secret for EAP_TLS          */
    int (*f_export_keys_for_eap_tls)( void *,
            unsigned char *,
            unsigned char *,
            unsigned char *, size_t,
            int (*tls_prf)(const unsigned char *, size_t, const char *,
                const unsigned char *, size_t, unsigned char *, size_t));
    void *p_export_keys_for_eap_tls;
#endif
...
/*
 * \brief Returns the list of ciphersuites supported by the SSL/TLS module.
 *        The list is ordered by preference of DA16X.
 *
 * \return              a statically allocated array of ciphersuites, the last
 *                      entry is 0.
 */
const int *mbedtls_ssl_list_da16x_ciphersuites( void );

/*
 * \brief Returns the list of ciphersuites supported by the SSL/TLS module with HW engine.
 *
 * \return              a statically allocated array of ciphersuites, the last
 *                      entry is 0.
 */
const int *mbedtls_ssl_list_da16x_hw_ciphersuites( void );
...
#if defined(MBEDTLS_SSL_EAP_TLS)
typedef int mbedtls_ssl_export_keys_for_eap_tls_t( void *p_expkey,
                                unsigned char *ms, //master
                                unsigned char *rb, //randbytes(fixed length: 64 bytes)
