...
/* MAC Protocol using buffer */
#if 0
LWIP_MEMPOOL(UMAC_BUFF, ((UMAC_TX_SKB + UMAC_RX_SKB)),	MAC_PKT_BUF_SIZE,	"UMAC_BUFF")
#endif
LWIP_MEMPOOL(UMAC_BUFF_RX, PBUF_POOL_SIZE,  MAC_PKT_BUF_SIZE,    "UMAC_BUFF_RX")
