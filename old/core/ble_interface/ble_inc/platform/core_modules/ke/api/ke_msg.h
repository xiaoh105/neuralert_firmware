...
#include "../../../../platform/arch/arch.h"            // architectural definition
#include "../../../../platform/arch/compiler/compiler.h"        // compiler definition
 ...
 ****************************************************************************************
 */
__INLINE void * ke_msg2param(struct ke_msg const *message)
{
    return (void*) (((uint8_t*) message) + offsetof(struct ke_msg, param));
}
