...
extern void	tcp_server_dpm_sample(void *param);
#endif // (__TCP_SERVER_DPM_SAMPLE__)
...
static const app_task_info_t	sample_apps_table[] = {
    ...
    // Network Samples
#if defined (__TCP_SERVER_DPM_SAMPLE__)
    { SAMPLE_TCP_SVR_DPM,				tcp_server_dpm_sample,					1024, (OS_TASK_PRIORITY_USER + 6), TRUE, FALSE,	TCP_SVR_TEST_PORT,		RUN_ALL_MODE },
#endif // (__TCP_SERVER_DPM_SAMPLE__)
