...
extern void	udp_socket_sample(void *param);
#endif // (__UDP_CLIENT_SAMPLE__)
...
static const app_task_info_t	sample_apps_table[] = {
    ...
    // Network Samples
#if defined (__UDP_SOCKET_SAMPLE__)
    { SAMPLE_UDP_SOCK,				udp_socket_sample,					512, (OS_TASK_PRIORITY_USER + 6), TRUE, FALSE,	UDP_CLI_TEST_PORT,		RUN_ALL_MODE },
#endif // (__UDP_CLIENT_SAMPLE__)
