...
extern void	udp_server_dpm_sample(void *param);
#endif // (__UDP_SERVER_DPM_SAMPLE__)
...
static const app_task_info_t	sample_apps_table[] = {
    ...
    // Network Samples
#if defined (__UDP_SERVER_DPM_SAMPLE__)
    { SAMPLE_UDP_SVR_DPM,				udp_server_dpm_sample,					1024 / sizeof(StackType_t), (OS_TASK_PRIORITY_USER + 6), TRUE, FALSE,	UDP_SVR_TEST_PORT,		RUN_ALL_MODE },
#endif // (__UDP_SERVER_DPM_SAMPLE__)
