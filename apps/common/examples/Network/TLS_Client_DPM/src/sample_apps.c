...
#if defined (__TLS_CLIENT_DPM_SAMPLE__)
extern void	tls_client_dpm_sample(void *param);
#endif // (__TLS_CLIENT_DPM_SAMPLE__)
...
static const app_task_info_t	sample_apps_table[] = {
    ...
    // Network Samples
#if defined (__TLS_CLIENT_DPM_SAMPLE__)
    { SAMPLE_TLS_CLI_DPM,				tls_client_dpm_sample,					(128 * 10), (OS_TASK_PRIORITY_USER + 6), TRUE, FALSE,	TLS_CLI_TEST_PORT,		RUN_ALL_MODE },
#endif // (__TLS_CLIENT_DPM_SAMPLE__)
