...
extern void	dtls_server_dpm_sample(void *param);
#endif // (__DTLS_SERVER_DPM_SAMPLE__)
...
static const app_task_info_t	sample_apps_table[] = {
    ...
    // Network Samples
#if defined (__DTLS_SERVER_DPM_SAMPLE__)
    { SAMPLE_DTLS_SVR_DPM,				dtls_server_dpm_sample,					(128 * 10), (OS_TASK_PRIORITY_USER + 6), TRUE, FALSE,	DTLS_SVR_TEST_PORT,		RUN_ALL_MODE },
#endif // (__DTLS_SERVER_DPM_SAMPLE__)
