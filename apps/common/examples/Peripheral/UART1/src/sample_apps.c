...
extern void	run_uart1_sample(void *param);
#endif // (__PERIPHERAL_SAMPLE_UART__)
...
static const app_task_info_t	sample_apps_table[] = {
    ...
    // Peripheral Samples
#if defined (__PERIPHERAL_SAMPLE_UART__)
    { SAMPLE_UART1,			run_uart1_sample,					512, (OS_TASK_PRIORITY_USER + 6), FALSE, FALSE,	UNDEF_PORT,				RUN_ALL_MODE },
#endif // (__PERIPHERAL_SAMPLE_UART__)
