...
extern void	run_gpio_retention_sample(void *param);
#endif
...
#if defined (__PERIPHERAL_SAMPLE_GPIO_RETENTION__)
    { SAMPLE_GPIO_RETENTION,			run_gpio_retention_sample,					512, (OS_TASK_PRIORITY_USER + 6), FALSE, FALSE,	UNDEF_PORT,				RUN_ALL_MODE },
#endif
