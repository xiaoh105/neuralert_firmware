...
#else
	da16x_wpa_prt("<%s> WPA: PTK derivation - A1=" MACSTR " A2=" MACSTR "\n",
        __func__, MAC2STR(addr1), MAC2STR(addr2));
	da16x_dump("WPA: Nonce1", nonce1, WPA_NONCE_LEN);
    da16x_dump("WPA: Nonce2", nonce2, WPA_NONCE_LEN);
    da16x_dump("WPA: PMK", pmk, pmk_len);
    da16x_dump("WPA: PTK", tmp, ptk_len);
...
const char * wpa_cipher_txt(int cipher)
{
	...
	case WPA_CIPHER_CCMP_256:
		return "CCMP-256";
#if defined CONFIG_SAE || defined CONFIG_IEEE80211W || defined CONFIG_OWE
