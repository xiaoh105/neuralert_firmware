...
#if 1 
	/*
	리비전: cef8fac04b25bb0c648447513aee652b6f828256
	작성자: Johannes Berg <johannes.berg@intel.com>
	날짜: 2017-01-27 오전 12:24:06
	메시지:
	wpa_auth : 구조체 wpa_auth_callbacks를 const로 만듭니다.
	wpa_auth_callbacks 구조체를 복사하는 대신 포인터를 유지하고 컨텍스트 포인터를 별도로 유지 한 다음 사용자가 정적 구조체를 제공하게하십시오. 함수 포인터가 다른 곳으로 이동하기 때문에 힙 덮어 쓰기의 공격 표면이 줄어 듭니다.
	*/
