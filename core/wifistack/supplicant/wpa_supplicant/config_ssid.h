...
#if 0 // bt shingu 20200527 (PSK->NONE)// trinity_0151001
...
#define DEFAULT_MESH_RETRY_TIMEOUT 80		//40
/* MPM Plink Timer check the timeout , increase */
#define DEFAULT_MESH_CONFIRM_TIMEOUT 120		//80		//40
#define DEFAULT_MESH_HOLDING_TIMEOUT 80		//40
...
#define DEFAULT_AUTH_MAX_FAILURES 3
...
struct wpa_ssid {
	 ...
	 * such drivers to use hidden SSIDs. Note2: Most nld11-based drivers
...
#ifdef CONFIG_AUTH_MAX_FAILURES
	unsigned int auth_max_failures;
#endif // CONFIG_AUTH_MAX_FAILURES
	/**
