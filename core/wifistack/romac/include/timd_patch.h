 ...
 * @file     timd_patch.h
 *
 * @brief    TIM debug configuration patch header
 *
...
#ifndef __TIMD_PATCH_H__
#define __TIMD_PATCH_H__
...
#undef TIMD_DATA_EN
#undef TIMD_INFO_EN        ///< 0x00000004
#undef TIMD_WARNING_EN     ///< 0x00000008
#undef TIMD_ERROR_EN       ///< 0x00000010
#undef TIMD_C_EN
#undef TIMD_PREP_EN        ///< 0x00000040
#undef TIMD_SCHE_EN       ///< 0x00000080
#undef TIMD_P_EN           ///< 0x00000100
#undef TIMD_APTRK_EN       ///< 0x00000200
#undef TIMD_PBR_EN         ///< 0x00000400
#undef TIMD_T_EN          ///< 0x00000800
#undef TIMD_KA_EN          ///< 0x00001000
#undef TIMD_AUTO_ARP_EN    ///< 0x00002000; Auto ARP
#undef TIMD_UDPH_EN        ///< 0x00010000; UDP Hole-punch
#undef TIMD_TIME_EN        ///< 0x00020000
#undef TIMD_RX_EN          ///< 0x00040000
#undef TIMD_BCN_EN         ///< 0x00080000
#undef TIMD_BCMC_EN        ///< 0x00100000
#undef TIMD_PS_EN          ///< 0x00200000
#undef TIMD_UC_EN          ///< 0x00400000
#undef TIMD_TX_EN          ///< 0x00800000
#undef TIMD_ARPREQ_EN      ///< 0x00004000
#undef TIMD_DEAUTH_EN      ///< 0x00008000
#undef TIMD_DATA_BCN_EN    ///< 0x01000000
#undef TIMD_DATA_MGMT_EN   ///< 0x02000000
#undef TIMD_DATA_DATA_EN   ///< 0x04000000
#undef TIMD_DATA_CTRL_EN   ///< 0x08000000
...
#define LL2HI(ll) ((long) ((ll >> 32LL) & 0xffffffff))
#define LL2LO(ll) ((long) (ll & 0xffffffff))
...
enum TIMD_FEATURE {
	...
	/// Don't touch.
	/// It is controlled by DATA_BCN, DATA_MGMT, DATA_DATA and DATA_CTRL
	...
	/// These features need to TIMD_DATA.
	TIMD_DATA_BCN   = 0x01000000,
	TIMD_DATA_MGMT  = 0x02000000,
	TIMD_DATA_DATA  = 0x04000000,
	TIMD_DATA_CTRL  = 0x08000000,
...
#define TIMD_P_K(timd, s, n) \
	timd_y_k_n(timd, TIMD_P, s, n)
#define TIMD_P_N(timd, s, n) \
	timd_y_n(timd, TIMD_P, s, n)
#define TIMD_P_S(timd, s, s1) \
	timd_y_s(timd, TIMD_P, s, s1)
#else
#define TIMD_P_K(timd, s, n)
#define TIMD_P_N(timd, s, n)
#define TIMD_P_S(timd, s, s1)
