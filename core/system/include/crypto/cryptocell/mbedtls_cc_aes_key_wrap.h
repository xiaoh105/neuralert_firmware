...
CCError_t mbedtls_aes_key_wrap(
            ...
            size_t        keySize,                   /*!< [in] The size of the key in Bytes. Valid values are:
                                                          <ul><li>16 Bytes</li><li>24 Bytes</li><li>32 Bytes</li></ul> */
            ...
            size_t*       pCipherTextSize            /*!< [in/out] <ul><li>Input: A pointer to the size of the cipher-text output data buffer.</li>
                                                          <li>Output: The actual size of the cipher-text output data in Bytes.</li></ul> */
);
...
CCError_t mbedtls_aes_key_unwrap(
              ...
              uint8_t*      keyBuf,                  /*!< [in] A pointer to AES key-wrapping key. */
              size_t        keySize,                 /*!< [in] The size of the key in Bytes. Valid values are:<ul><li>16 Bytes</li><li>24 Bytes</li><li>32 Bytes</li></ul> */
              ...
              size_t*       pPlainTextSize          /*!< [in/out] <ul><li>Input: A pointer to the size of the plain-text output data buffer.</li>
                                                          <li>Output: The actual size of the plain-text output data in Bytes.</li></ul> */
);
