...
ApplicationWindow {
	...
	TextArea {
		...
		x: 40
		y: 20
		text: qsTr("Developer RMA Debug Config")
		readOnly: true
	}
			...
			Row {
				...
				Rectangle {
					...
					TextEdit {
						...
						text: if( visiblesocid() == true ) { devrmaman.socid } else { qsTr("") }
	...
	Column {
		...
		Column { 
			...
			CheckBox {
				...
				checked: getdbgmask_con(devrmaman.debugmask0)
			...
			CheckBox {
				...
				checked: getdbgmask_swd(devrmaman.debugmask0)
	...
	Column {
		...
		Row {
			...
			Button {
				...
				ToolTip.visible: hovered
				ToolTip.text: qsTr("Update Developer-RMA-cfg")		
