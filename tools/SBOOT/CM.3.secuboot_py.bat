...
rem set TOOLNAME=".\certtool\da16secutool.exe"
set TOOLNAME=".\certtool_py\da16secutool.py"
...
if %argc% equ 0 python %TOOLNAME% -mod secuboot -cfg ./cmconfig/da16xtpmconfig.cfg -tpm ./cmtpmcfg

REM Normal Build
if %argc% gtr 1 python %TOOLNAME% -mod secuboot -cfg ./cmconfig/da16xtpmconfig.cfg -tpm ./cmtpmcfg
...
@echo *----------------------------------------
@echo.
python %TOOLNAME% -mod secuboot -cfg ./cmconfig/da16xtpmconfig.cfg
